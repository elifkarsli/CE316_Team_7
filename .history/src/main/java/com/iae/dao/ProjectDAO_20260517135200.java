...
public class ProjectDAO {
    ...
    public void delete(int id) throws SQLException {
        PreparedStatement ps = db.getConnection().prepareStatement("DELETE FROM projects WHERE id=?");
        ps.setInt(1, id);
        ps.executeUpdate();
    }
    ...
    public Project findById(int id) throws SQLException {
        PreparedStatement ps = db.getConnection().prepareStatement("SELECT * FROM projects WHERE id=?");
        ps.setInt(1, id);
